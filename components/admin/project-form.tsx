...
export function ProjectForm({ initialData }: ProjectFormProps) {
  ...
  const handleScreenshotChange = (index: number, field: keyof Screenshot, value: string) => {
  ...
  const addScreenshot = () => {
    setFormData((prev) => ({
      ...prev,
      screenshots: [...prev.screenshots, { title: "", image: "", description: "" }],
    }))
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: `Project ${initialData.id ? "updated" : "created"} successfully.`,
      })
              ...
              <CardContent className="pt-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">Add the technologies used in this project</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="pt-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">Add the key features of this project</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                    ...
                    <div key={index} className="relative space-y-4 rounded-md border p-4">
                      ...
                      <div className="grid gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => handleScreenshotChange(index, "title", e.target.value)}
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => handleScreenshotChange(index, "image", e.target.value)}
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => handleScreenshotChange(index, "description", e.target.value)}
